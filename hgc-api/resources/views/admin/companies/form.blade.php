...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="p-5 bg-gray-800 border border-gray-700 rounded-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-300">Slug <span
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-300">Icon Name <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="icon_name"
                        value="{{ old('icon_name', $company->icon_name ?? 'Building2') }}"
                        class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
                        required>
                </div>
            </div>
    ...
    <div class="space-y-6">
        ...
        <div class="p-5 bg-gray-800 border border-gray-700 rounded-xl">
            ...
            <div class="space-y-4">
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-300">Accent Color <span
                            class="text-red-500">*</span></label>
