            ...
            <div class="p-4 sm:p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_dari" value="{{ old('title_dari', $event->title_dari) }}"
                            dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Title (Pashto)</label>
                        <input type="text" name="title_pashto" value="{{ old('title_pashto', $event->title_pashto) }}"
                            dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <textarea name="description_en" rows="3"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">{{ old('description_en', $event->description_en) }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="description_dari" rows="3" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">{{ old('description_dari', $event->description_dari) }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="description_pashto" rows="3" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">{{ old('description_pashto', $event->description_pashto) }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="location_en" value="{{ old('location_en', $event->location_en) }}"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Location (Dari)</label>
                        <input type="text" name="location_dari"
                            value="{{ old('location_dari', $event->location_dari) }}" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Location (Pashto)</label>
                        <input type="text" name="location_pashto"
                            value="{{ old('location_pashto', $event->location_pashto) }}" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="event_time" value="{{ old('event_time', $event->event_time) }}"
                    ...
                    <div>
                        ...
                        @if ($event->cover_image)
                            <div class="mb-3">
                                <img src="{{ asset('storage/' . $event->cover_image) }}" alt="Current cover"
                                    class="h-24 w-auto rounded-lg border border-gray-600 object-cover">
                                <p class="mt-1 text-xs text-gray-500">Current: {{ $event->cover_image }}</p>
                            </div>
                        @endif
