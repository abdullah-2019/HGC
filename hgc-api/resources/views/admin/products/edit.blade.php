...
@section('content')
    <div class="space-y-6" x-data="productForm()">
        ...
        <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data"
            ...
            <!-- Tabs Navigation -->
            <div class="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden p-2">
                <div class="border-b border-gray-700">
                    <nav class="flex space-x-2 p-1 overflow-x-auto" aria-label="Tabs">
                        <button type="button" @click="activeTab = 'basic'"
                            :class="activeTab === 'basic' ? 'bg-gray-700 text-white' :
                                'text-gray-400 hover:text-white hover:bg-gray-700/50'"
                            class="px-4 py-3 text-sm font-medium rounded-lg transition-colors whitespace-nowrap">
                            Basic Info
                        </button>
                ...
                <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="tagline_dari" name="tagline_dari"
                                        value="{{ old('tagline_dari', $product->tagline_dari) }}" dir="rtl"
                                        class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="tagline_pashto" name="tagline_pashto"
                                        value="{{ old('tagline_pashto', $product->tagline_pashto) }}" dir="rtl"
                                        class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="price_range" name="price_range"
                                    value="{{ old('price_range', $product->price_range) }}"
                                    class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                            ...
                            <div>
                                ...
                                <select id="currency" name="currency" required
                                    class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                    <option value="AFN"
                                        {{ old('currency', $product->currency) == 'AFN' ? 'selected' : '' }}>AFN (Afghan
                                        Afghani)</option>
                                    <option value="USD"
                            ...
                            <div>
                                ...
                                <select id="availability" name="availability" required
                                    ...
                                    <option value="in_stock"
                                        {{ old('availability', $product->availability) == 'in_stock' ? 'selected' : '' }}>
                                        In Stock</option>
                                    <option value="limited"
                                        {{ old('availability', $product->availability) == 'limited' ? 'selected' : '' }}>
                                        Limited</option>
                                    <option value="pre_order"
                                        {{ old('availability', $product->availability) == 'pre_order' ? 'selected' : '' }}>
                                        Pre-Order</option>
                                    <option value="out_of_stock"
                                        {{ old('availability', $product->availability) == 'out_of_stock' ? 'selected' : '' }}>
                                        Out of Stock</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div x-show="activeTab === 'images'" x-cloak>
                        ...
                        @if ($product->hero_image_url)
                            <div class="mb-6">
                                ...
                                <div class="w-48 h-24 rounded-lg overflow-hidden bg-gray-700 border border-gray-600">
                                    <img src="{{ $product->hero_image_url }}" alt="Hero"
                                        class="w-full h-full object-cover">
                                </div>
                                <label class="flex items-center mt-2">
                                    <input type="checkbox" name="delete_hero_image" value="1"
                                        class="w-4 h-4 text-red-600 bg-gray-700 border-gray-600 rounded focus:ring-red-600">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                                    @foreach ($product->images as $image)
                                        <div class="relative group">
                                            <div
                                                class="aspect-square rounded-lg overflow-hidden bg-gray-700 border border-gray-600">
                                            ...
                                            <label class="absolute top-2 right-2">
                                                <input type="checkbox" name="deleted_image_ids[]"
                                                    value="{{ $image->id }}"
                                                    class="w-4 h-4 text-red-600 bg-gray-700 border-gray-600 rounded focus:ring-red-600">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- Hero Image -->
                            <div>
                                <label for="hero_image" class="block mb-2 text-sm font-medium text-white">Replace Hero
                                    Image</label>
                            ...
                            <!-- Thumbnail -->
                            <div>
                                <label for="thumbnail" class="block mb-2 text-sm font-medium text-white">Replace
                                    Thumbnail</label>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="meta_title_en" name="meta_title_en"
                                    value="{{ old('meta_title_en', $product->meta_title_en) }}" maxlength="150"
                                    class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                            ...
                            <div>
                                ...
                                <input type="text" id="meta_desc_en" name="meta_desc_en"
                                    value="{{ old('meta_desc_en', $product->meta_desc_en) }}" maxlength="300"
                                    class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
            ...
            <div class="flex items-center justify-end gap-3 mt-6">
                ...
                <a href="{{ route('admin.products.index') }}"
                    ...
                    class="px-5 py-3 text-sm font-medium rounded-lg hover:bg-gray-600 transition-all duration-150 items-center justify-center text-center shadow-sm focus:outline-none">
                    Cancel
                </a>

                <!-- Update Product Button: Styled as a bold, prominent primary button -->
                <button type="submit"
