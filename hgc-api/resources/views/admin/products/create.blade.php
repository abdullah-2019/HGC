            ...
            <div class="p-6 space-y-6">
                ...
                <div x-show="activeTab === 'basic'" x-cloak>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name_dari" name="name_dari" value="{{ old('name_dari') }}" dir="rtl"
                                   class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                        ...
                        <div>
                            ...
                            <input type="text" id="name_pashto" name="name_pashto" value="{{ old('name_pashto') }}" dir="rtl"
                                   class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" id="tagline_en" name="tagline_en" value="{{ old('tagline_en') }}"
                                       class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                            ...
                            <div>
                                ...
                                <input type="text" id="tagline_dari" name="tagline_dari" value="{{ old('tagline_dari') }}" dir="rtl"
                                       class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                            ...
                            <div>
                                ...
                                <input type="text" id="tagline_pashto" name="tagline_pashto" value="{{ old('tagline_pashto') }}" dir="rtl"
                                       class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <select id="currency" name="currency" required
                                    class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                <option value="AFN" {{ old('currency', 'AFN') == 'AFN' ? 'selected' : '' }}>AFN (Afghan Afghani)</option>
                        ...
                        <div>
                            ...
                            <select id="availability" name="availability" required
                                    class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                <option value="in_stock" {{ old('availability', 'in_stock') == 'in_stock' ? 'selected' : '' }}>In Stock</option>
                                <option value="limited" {{ old('availability') == 'limited' ? 'selected' : '' }}>Limited</option>
                ...
                <div x-show="activeTab === 'images'" x-cloak>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <!-- Hero Image -->
                        <div>
                            <label for="hero_image" class="block mb-2 text-sm font-medium text-white">Hero Image</label>
                            ...
                            <template x-for="(image, index) in images" :key="index">
                                <div class="bg-gray-700/30 rounded-lg p-4 space-y-3">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm font-medium text-gray-300" x-text="`Image #${index + 1}`"></span>
                ...
                <div x-show="activeTab === 'seo'" x-cloak>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_title_en" name="meta_title_en" value="{{ old('meta_title_en') }}" maxlength="150"
                                   class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_desc_en" name="meta_desc_en" value="{{ old('meta_desc_en') }}" maxlength="300"
                                   class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 placeholder-gray-500"
