...
@if($relativePath)
    ...
    <a
        href="{{ route('admin.media.browser', ['path' => $parent]) }}"
...
<div class="grid grid-cols-4 gap-4 mb-8">
    ...
    @foreach($folders as $folder)
        ...
        <a
            href="{{ route('admin.media.browser', ['path' => $folder['path']]) }}"
...
<div class="grid grid-cols-4 gap-4">
    ...
    @foreach($images as $image)
        ...
        <div
            class="bg-gray-800 border border-gray-700 rounded overflow-hidden cursor-pointer hover:border-blue-500"
