            ...
            <div class="p-4 sm:p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input required type="file" name="image_file" accept="image/webp,image/jpeg,image/png"
                    ...
                    <div>
                        ...
                        <select name="ken_burns"
                            ...
                            <option value="zoom-in" {{ old('ken_burns', 'zoom-in') == 'zoom-in' ? 'selected' : '' }}>Zoom In
                            </option>
                            <option value="zoom-out" {{ old('ken_burns') == 'zoom-out' ? 'selected' : '' }}>Zoom Out
                            </option>
                            <option value="pan-right" {{ old('ken_burns') == 'pan-right' ? 'selected' : '' }}>Pan Right
                            </option>
                            <option value="pan-left" {{ old('ken_burns') == 'pan-left' ? 'selected' : '' }}>Pan Left
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="highlights_en" value="{{ old('highlights_en') }}" placeholder="e.g. 1"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white placeholder-gray-400 focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                        <p class="mt-1 text-xs text-gray-500">Comma-separated index numbers (0-based) to highlight in gold.
                        </p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Highlights (Dari)</label>
                        <input type="text" name="highlights_dari" value="{{ old('highlights_dari') }}"
                            placeholder="e.g. 1" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Highlights (Pashto)</label>
                        <input type="text" name="highlights_pashto" value="{{ old('highlights_pashto') }}"
                            placeholder="e.g. 1" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <textarea name="subtitle_en" rows="2"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors" required>{{ old('subtitle_en') }}</textarea>
                        @error('subtitle_en')
                            <p class="mt-1 text-xs text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <textarea name="subtitle_dari" rows="2" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors" required>{{ old('subtitle_dari') }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="subtitle_pashto" rows="2" dir="rtl"
                            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-colors" required>{{ old('subtitle_pashto') }}</textarea>
                    </div>
                </div>
