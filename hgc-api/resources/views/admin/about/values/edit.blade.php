    ...
    <div class="min-h-screen bg-gray-950 p-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-white tracking-tight">Edit Core Value</h1>
                    <p class="text-gray-400 mt-2 text-sm">Update value content across all languages</p>
                </div>
                ...
                <div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 sm:p-8 mb-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                        ...
                        <div dir="rtl">
                            ...
                            <input type="text" name="title_pashto" value="{{ old('title_pashto', $value->title_pashto) }}"
