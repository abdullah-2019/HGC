...
<div x-data="{
    ...
    async save() {
        ...
        try {
            ...
            this.showToast(e.message || 'Failed to save contact information', 'error');
        } finally {
            this.saving = false;
        }
    },
    ...
    <div class="border-b border-gray-700">
        <nav class="flex gap-1" aria-label="Tabs">
            <button @click="activeTab = 'en'"
                    :class="activeTab === 'en' ? 'border-primary-500 text-primary-400' : 'border-transparent text-gray-400 hover:text-gray-300 hover:border-gray-600'"
                    class="px-4 py-2.5 text-sm font-medium border-b-2 transition-colors">
                English
            </button>
            <button @click="activeTab = 'dari'"
                    :class="activeTab === 'dari' ? 'border-primary-500 text-primary-400' : 'border-transparent text-gray-400 hover:text-gray-300 hover:border-gray-600'"
                    class="px-4 py-2.5 text-sm font-medium border-b-2 transition-colors" dir="rtl">
                دری
            </button>
            <button @click="activeTab = 'pashto'"
                    :class="activeTab === 'pashto' ? 'border-primary-500 text-primary-400' : 'border-transparent text-gray-400 hover:text-gray-300 hover:border-gray-600'"
                    class="px-4 py-2.5 text-sm font-medium border-b-2 transition-colors" dir="rtl">
                پښتو
            </button>
        </nav>
        ...
        <div class="rounded-lg border border-gray-700 bg-gray-800 overflow-hidden">
            ...
            <div class="p-4 grid gap-4 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2 space-y-2">
                    ...
                    <input type="text" x-model="data.office_hours" placeholder="Saturday - Thursday, 8:00 AM - 5:00 PM"
                           class="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
            </div>
        </div>
        ...
        <div class="rounded-lg border border-gray-700 bg-gray-800 overflow-hidden">
            ...
            <div class="p-4 grid gap-4 sm:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" x-model="data.phones_dari" placeholder="Enter phones in Dari" dir="rtl"
                           class="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
                <div class="space-y-2">
                ...
                <div class="sm:col-span-2 space-y-2">
                    ...
                    <input type="text" x-model="data.office_hours_dari" placeholder="Enter office hours in Dari" dir="rtl"
                           class="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
            </div>
        </div>
        ...
        <div class="rounded-lg border border-gray-700 bg-gray-800 overflow-hidden">
            ...
            <div class="p-4 grid gap-4 sm:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" x-model="data.phones_pashto" placeholder="Enter phones in Pashto" dir="rtl"
                           class="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-medium text-gray-300">Email (Pashto)</label>
                    <input type="email" x-model="data.email_pashto" placeholder="Enter email in Pashto" dir="rtl"
                           class="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
                <div class="sm:col-span-2 space-y-2">
                    <label class="block text-sm font-medium text-gray-300">Office Hours (Pashto)</label>
                    <input type="text" x-model="data.office_hours_pashto" placeholder="Enter office hours in Pashto" dir="rtl"
                           class="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                </div>
            </div>
        </div>
    ...
    <div class="flex justify-end">
        <button @click="save" :disabled="saving"
            ...
            <svg x-show="saving" class="w-5 h-5 mr-2 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
            </svg>
