      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 lg:h-24">
          ...
          <div className="flex items-center gap-3">
            {/* Language Dropdown - Shows language name only */}
            <div className="relative">
              <button
                onClick={() => setLangMenuOpen(!langMenuOpen)}
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#C9A227]/30 transition-all duration-300 text-sm"
              >
              ...
              {langMenuOpen && (
                <>
                  ...
                  />
                  <div className="absolute top-full mt-2 right-0 z-20 bg-[#0A1628]/98 backdrop-blur-2xl border border-white/10 rounded-xl shadow-2xl p-1.5 min-w-[140px]">
                    {languages.map((l) => (
                      <button
                        key={l.code}
                        onClick={() => {
