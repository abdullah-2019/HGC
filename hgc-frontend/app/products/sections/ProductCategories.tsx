    ...
    products: [
      {
        ...
        specs: ["Grade: 25-35% Cu", "Origin: Logar Province"],
        icon: Mountain,
      },
      {
        id: "p2",
        ...
        specs: ["Grade: 62-65% Fe", "Origin: Hajigak"],
        icon: Mountain,
      },
      {
        id: "p3",
        ...
        specs: ["Grade: 42-48% Cr₂O₃", "Origin: Khost"],
        icon: Mountain,
      },
      {
        id: "p4",
    ...
    products: [
      {
        ...
        specs: ["Grade: AAA", "Origin: Badakhshan"],
        icon: Diamond,
      },
      {
        id: "p6",
        ...
        specs: ["Grade: A-AA", "Origin: Panjshir"],
        icon: Diamond,
      },
      {
        id: "p7",
        ...
        specs: ["Types: White / Onyx / Travertine", "Origin: Herat / Helmand"],
        icon: Mountain,
      },
      {
        id: "p8",
        ...
        specs: ["Colors: Black / Red / Grey", "Origin: Kabul"],
        icon: Mountain,
      },
    ],
  },
    ...
    products: [
      {
        ...
        specs: ["Octane: 95 / 98", "Grade: Euro 5"],
        icon: Flame,
      },
      {
        id: "p10",
        ...
        specs: ["Sulfur: <10 ppm", "Grade: Euro 5"],
        icon: Truck,
      },
      {
        id: "p11",
        ...
        specs: ["Purity: 99.5%", "Packaging: Cylinder / Bulk"],
        icon: Flame,
      },
      {
        id: "p12",
        ...
        specs: ["Grades: 60/70 / 80/100", "Origin: Domestic Refinery"],
        icon: Droplets,
      },
    ],
  },
    ...
    products: [
      {
        ...
        specs: ["Type: OPC 42.5 / 52.5", "Standard: ASTM C150"],
        icon: Boxes,
      },
      {
        id: "p14",
        ...
        specs: ["Grades: Grade 40 / 60", "Sizes: 8mm - 32mm"],
        icon: HardHat,
      },
      {
        id: "p15",
        ...
        specs: ["Strength: C20 - C50", "Delivery: On-site"],
        icon: Truck,
      },
      {
        id: "p16",
        ...
        specs: ["Profiles: I-Beam / H-Beam / Angle", "Steel: S235 / S355"],
        icon: HardHat,
      },
    ],
  },
    ...
    products: [
      {
        ...
        specs: ["Nitrogen: 46%", "Form: Prilled / Granular"],
        icon: Boxes,
      },
      {
        id: "p18",
        ...
        specs: ["NPK: 15-15-15 / 20-20-20", "Form: Granular"],
        icon: Boxes,
      },
      {
        id: "p19",
        ...
        specs: ["Concentration: 98%", "Grade: Technical"],
        icon: Droplets,
      },
      {
        id: "p20",
        ...
        specs: ["Form: Flakes / Pearls", "Purity: 99%"],
        icon: Boxes,
      },
    ],
  },
