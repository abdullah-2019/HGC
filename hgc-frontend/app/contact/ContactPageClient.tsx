...
export default function ContactPageClient({ contactInfo, error }: Props) {
  ...
  const inputClasses =
    "w-full rounded-xl border border-hgc-border bg-hgc-surface-elevated px-5 py-4 text-hgc-text placeholder-hgc-text-muted transition-all focus:border-hgc-gold focus:outline-none focus:ring-2 focus:ring-hgc-gold/20";
  ...
  return (
    <main className="min-h-screen bg-hgc-bg">
      {/* ========== HERO ========== */}
      <section className="relative h-[60vh] min-h-[400px] w-full overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-b from-hgc-navy/60 via-hgc-navy/40 to-hgc-navy/70" />
        </div>
      ...
      {/* ========== FORM + INFO ========== */}
      <section className="relative overflow-hidden bg-hgc-bg py-24" dir={dir}>
        <div className="absolute inset-0">
          <div className="absolute left-0 top-0 h-96 w-96 rounded-full bg-hgc-gold/5 blur-3xl" />
          <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-hgc-gold/5 blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-hgc-text md:text-5xl">
              {t(lang, "contact.send_message")}
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-hgc-text-muted">
          ...
          <div className="grid gap-8 lg:grid-cols-5">
            ...
            >
              <div className="rounded-3xl border border-hgc-border bg-hgc-card p-8 shadow-sm md:p-10">
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid gap-5 sm:grid-cols-2">
                    <div className="relative">
                      <User
                        className={`absolute top-1/2 -translate-y-1/2 text-hgc-text-muted ${dir === "rtl" ? "right-4" : "left-4"
                          }`}
                        size={20}
                      />
                      <input
                  ...
                  <div className="relative">
                    <MessageSquare
                      className={`absolute top-4 text-hgc-text-muted ${dir === "rtl" ? "right-4" : "left-4"
                        }`}
                      size={20}
                    />
                    <textarea
                  ...
                  <button
                    ...
                    className="group flex w-full items-center justify-center gap-3 rounded-xl bg-hgc-gold px-8 py-4 text-lg font-semibold text-hgc-navy transition-all hover:bg-hgc-gold-bright hover:shadow-lg hover:shadow-hgc-gold/20 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {status === "loading" ? (
                  ...
                  {status === "success" && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="rounded-xl border border-green-500/20 bg-green-500/10 p-4 text-center text-green-600"
                    >
                  ...
                  {status === "error" && (
                    <motion.div
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-center text-red-500"
                    >
            ...
            >
              ...
              {error && (
                <motion.div
                  ...
                  className="rounded-2xl border border-red-500/20 bg-red-500/10 p-6 text-red-500"
                >
              ...
              {address && (
                <motion.div
                  variants={itemVariants}
                  className="rounded-2xl border border-hgc-border bg-hgc-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-hgc-gold/30 hover:shadow-md"
                >
                  <div className="mb-4 flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-hgc-gold/15 text-hgc-gold">
                      <Building2 size={20} />
                    </div>
                    <h3 className="text-lg font-semibold text-hgc-text">
                  ...
                  <div className="flex items-start gap-3">
                    <MapPin
                      size={18}
                      className="mt-1 shrink-0 text-hgc-gold"
                    />
                  ...
                  {email && (
                    <div className="mt-3 flex items-center gap-3">
                      <Mail size={18} className="shrink-0 text-hgc-gold" />
                      <a
                        href={`mailto:${email}`}
                        className="text-hgc-text-secondary transition-colors hover:text-hgc-gold"
                      >
              ...
              {officeHours && (
                ...
                >
                  ...
                  <p className="text-hgc-text-secondary">{officeHours}</p>
                </motion.div>
              )}
                  ...
                  <div className="flex flex-wrap gap-3">
                    {socialLinks.map(({ icon: Icon, href, label }) => (
                      <a
                        ...
                        aria-label={label}
                        className="flex h-12 w-12 items-center justify-center rounded-xl bg-hgc-gold/10 text-hgc-gold transition-all duration-300 hover:-translate-y-1 hover:bg-hgc-gold hover:text-white hover:shadow-[0_0_25px_rgba(212,175,55,0.4)]"
                      >
                        <Icon size={18} />
                      </a>
                    ))}
      ...
      {/* ========== MAP ========== */}
      <section className="bg-hgc-bg py-20" dir={dir}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="overflow-hidden rounded-2xl bg-hgc-card border border-hgc-border shadow-sm"
          >
            <div className="relative h-[450px] w-full md:h-[500px]">
              ...
              <div
                className={`absolute bottom-6 max-w-sm rounded-xl bg-hgc-card border border-hgc-border p-6 shadow-2xl backdrop-blur-sm ${dir === "rtl" ? "right-6" : "left-6"
                  }`}
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-hgc-gold/15 text-hgc-gold">
                    <MapPin size={18} />
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-hgc-text">
                      {t(lang, "contact.kabul_office")}
                    </h4>
                    <p className="mt-1 text-xs text-hgc-text-muted">
                      {address ||
                    ...
                    {phones && (
                      <a
                        href={`tel:${phones.replace(/\s/g, "")}`}
                        className="mt-1.5 inline-block text-xs font-medium text-hgc-gold hover:text-hgc-gold-bright"
                        dir="ltr"
                      >
                        {phones}
                      </a>
