...
export default function ProjectOverview({ project }: ProjectOverviewProps) {
  ...
  return (
    <section className="relative py-20 lg:py-28" style={{ backgroundColor: "#FFFFFF" }}>
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
          <div className="lg:col-span-2">
            ...
            <ScrollReveal delay={0.1}>
              <h2 className="text-3xl lg:text-4xl font-bold mb-8" style={{ color: "#0F172A" }}>
            ...
            <ScrollReveal delay={0.2}>
              <div className="sticky top-24 space-y-4">
                <div className="p-6 rounded-2xl" style={{ backgroundColor: "#F8FAFC", border: "1px solid #E2E8F0" }}>
                  <h3 className="font-bold mb-6" style={{ color: "#0F172A" }}>
                    ...
                    {details.map((item, idx) => {
                      ...
                      return (
                        <div key={idx} className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs mb-0.5" style={{ color: "#94A3B8" }}>{lang === "en" ? item.labelEn : item.labelDari}</p>
                            <p className="text-sm font-medium" style={{ color: "#0F172A" }}>{lang === "en" ? item.valueEn : item.valueDari}</p>
                          </div>
                        </div>
                      );
                    })}
